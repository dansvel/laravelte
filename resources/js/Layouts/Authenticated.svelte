    ...
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              ...
              <BreezeNavLink href="/about" active={$page.component === 'About'}>
                About
              </BreezeNavLink>
              <BreezeNavLink href="/links" active={$page.component === 'Links/Index'}>
                Links
              </BreezeNavLink>
            </div>
          </div>
          ...
          <div class="-mr-2 flex items-center sm:hidden">
            <button
              on:click={(evt) => (showingNavigationDropdown = !showingNavigationDropdown)}
      ...
      >
        <div class="pt-2 pb-3 space-y-1">
          ...
          <BreezeResponsiveNavLink href="/about" active={$page.component === 'About'}>
            About
          </BreezeResponsiveNavLink>
          <BreezeResponsiveNavLink href="/links" active={$page.component === 'Links/Index'}>
            Links
          </BreezeResponsiveNavLink>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          ...
          <div class="mt-3 space-y-1">
            <BreezeResponsiveNavLink href="/logout" method="post" as="button">
              Log Out
            </BreezeResponsiveNavLink>
          </div>
        </div>
